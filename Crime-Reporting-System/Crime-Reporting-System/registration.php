		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">Aadhar Number</p><input type="text"  name="aadhar_number"  required  id="aadh" onfocusout="f1()"/>
					...
					<div class="right-agileits">
						<p style="color:#dfdfdf">Mobile</p><input type="text"  name="mobile_number" required  minlength="10"  id="mobno" onfocusout="f1()"/>
					</div>
