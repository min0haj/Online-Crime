...
if(isset($_POST['s'])){
    ...
    $sel_user ="select * from user where u_id='$email' AND u_pass='$pass'";
    ...
    echo " <script>alert('password or email is worng, please try again')</script>";
        ...
        $_SESSION['u_id']=$email;
        echo "<script>window.open('complainer_page.php?logged_in=you have successfuly login','_self')</script>";
    }
